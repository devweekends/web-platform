---
title: "A grad's guide to growing as a person & cracking tech"
description: "Seven years of mentoring distilled into one guide: the 3-step framework for becoming an outstanding engineer, how to approach DSA, build technical depth, and the mindset and daily schedule that hold it all together."
category: "Career & Tech Roles"
featured: true
order: 1
date: "2026-06-05"
author: "Zeeshan Adil"
...
image: "/guides/three-step-framework.svg"
---
...
![The three-step success framework: DSA, Technical Expertise, and University Courses](/guides/three-step-framework.svg)
...
1. Object-Oriented Programming (OOP) + Object-Oriented Analysis and Design (OOAD)
2. Programming languages and memory management
3. Databases and queries
4. Operating Systems (OS)
5. Networks
6. Mathematics courses like Calculus, Statistics, and Linear Algebra, which are crucial for fields like AI and machine learning
...
1. **DSA:** Doing well in ICPC and other international competitions (Facebook Hacker Cup, Codeforces, LeetCode contests)
2. **Tech:** Cracking GSoC or one of 20+ other programs
3. **Theory:** University course study (with ChatGPT and notes) plus a specialization from Coursera
...
- [Talk 1](https://youtu.be/UplO_4ROGf4)
- [Talk 2](https://youtu.be/4TRj3Oidatc)
- [Talk 3](https://youtu.be/t51dYk6EtEA)
...
- [Understanding your emotions](https://youtu.be/0gks6ceq4eQ)
...
- Walk + sunlight: get some fresh air and sunlight. Maybe try listening to [this](https://youtu.be/14G0pl1-IRQ?si=9wum-wW71cMv0VEt) in headphones while taking a walk
- Dhuhr prayer: midday prayer for spiritual refreshment
- Family time: spend quality time with family
- Write your thoughts on paper as questions and find their answers through talks. See [why all thoughts are questions](https://youtu.be/0gks6ceq4eQ)
...
- Deen Talk with dinner: combine dinner with discussions or talks on better connecting with your Creator and mental well-being through Islam. Some ideas and speakers:
  ...
  - [Talk 3](https://youtu.be/t51dYk6EtEA)
  - YouthClub Podcasts
  - Nouman Ali Khan talks and series like "Quran Akhir Mujzah", Quranic Gems, Get To Know, Amazed by the Quran (Seasons 1 and 2)
  - Sheikh Atif on motivation
  - Umar Series
  - Dr. Omar Suleiman series on the Prophet (P.B.U.H)
...
![A jagged but overall upward progress line](/guides/progress-graph.svg)
...
![The priority matrix with four quadrants by urgency and importance](/guides/priority-quadrants.svg)
